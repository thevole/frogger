...
var _user$project$Main$assertionListTests = A2(
	_elm_lang$core$List$map,
	...
	A2(
		...
		_elm_lang$core$Native_List.range(1, 10)));
var _user$project$Main$listTestSuite = A2(_elm_community$elm_test$ElmTest$suite, 'List Tests', _user$project$Main$assertionListTests);
var _user$project$Main$basicTests = A2(
	_elm_lang$core$Basics_ops['++'],
	_elm_lang$core$Native_List.fromArray(
		[
			A2(_elm_community$elm_test$ElmTest$equals, 0, 0),
			A2(
			...
			_elm_community$elm_test$ElmTest$test,
			'fail',
			A2(_elm_community$elm_test$ElmTest$assertNotEqual, true, false)),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'lazy',
			_elm_community$elm_test$ElmTest$lazyAssert(
				function (_p0) {
					return _elm_lang$core$Native_Utils.cmp(6, 5) > 0;
				}))
		]),
	A2(
		_elm_lang$core$List$map,
		...
		A2(
			...
			_elm_lang$core$Native_List.range(1, 10),
			_elm_lang$core$Native_List.range(1, 10))));
var _user$project$Main$basicTestSuite = A2(_elm_community$elm_test$ElmTest$suite, 'Basic Tests', _user$project$Main$basicTests);
var _user$project$Main$allTestSuite = A2(
	_elm_community$elm_test$ElmTest$suite,
	'All Tests',
	_elm_lang$core$Native_List.fromArray(
		[_user$project$Main$basicTestSuite, _user$project$Main$listTestSuite]));
var _user$project$Main$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_user$project$Main$allTestSuite)
};
